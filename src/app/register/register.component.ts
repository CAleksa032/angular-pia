...
export class RegisterComponent implements OnInit {
  ...
  register(){
      this.userService.registerPatient(this.username, this.password, this.type, this.phone, this.email, this.name, this.lastname, this.address, this.profilePicture).subscribe( respObj =>{
